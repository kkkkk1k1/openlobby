...
export default function GlobalSettingsDialog({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-[var(--color-surface-overlay)] flex items-center justify-center z-50" onClick={onClose}>
      <div
        className="w-[calc(100vw-32px)] md:w-auto mx-4 md:mx-0 bg-surface-secondary rounded-xl max-w-md border border-outline max-h-[80dvh] min-h-0 overflow-y-auto flex flex-col"
