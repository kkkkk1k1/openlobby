        ...
        {isEditing ? (
          ...
          <>
            ...
            <span
              ...
              className="md:invisible md:group-hover:visible shrink-0 p-0.5 rounded text-xs text-on-surface-muted hover:text-on-surface cursor-pointer transition-colors"
            ...
            <span
              ...
              className={`shrink-0 p-0.5 rounded text-xs cursor-pointer transition-colors ${
                isPinned
                  ...
                  : 'text-on-surface-muted hover:text-on-surface md:invisible md:group-hover:visible'
              }`}
...
export default function Sidebar(
  { onSessionSelect }: { onSessionSelect?: (sessionId: string) => void } = {},
) {
