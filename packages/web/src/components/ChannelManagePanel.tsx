...
export default function ChannelManagePanel({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-[var(--color-surface-overlay)] flex items-center justify-center z-50" onClick={onClose}>
      <div
        className="bg-surface-secondary rounded-xl p-6 w-[calc(100vw-32px)] md:w-full mx-4 md:mx-0 max-w-lg border border-outline max-h-[80dvh] md:max-h-[80vh] overflow-y-auto flex flex-col"
